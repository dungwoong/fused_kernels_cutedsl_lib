...
class Kernel:
  ...
  def __call__(self, mQ: cute.Tensor, mK: cute.Tensor, mV: cute.Tensor, mO: cute.Tensor):
    ...
    tiled_mma_69 = mma.get_tiled_mma(cutlass.BFloat16, True, True, cutlass.Float32, 128, 128, False)
    tiled_mma_100 = mma.get_tiled_mma(cutlass.BFloat16, True, False, cutlass.Float32, 128, 128, True)
    tiled_mma_140 = mma.get_tiled_mma(cutlass.BFloat16, True, True, cutlass.Float32, 128, 128, False)
    ...
    self.kernel(mQ, mK, mV, mO, sQ_layout, sK_layout, sV_layout, sO_layout, pv_acc_tiled_mma, tiled_mma_53, tiled_mma_69, tiled_mma_100, tiled_mma_140, mO_tma_atom_1, mO_tma_tensor_1, mQ_tma_atom_2, mQ_tma_tensor_2, mK_tma_atom_3, mK_tma_tensor_3, mV_tma_atom_4, mV_tma_tensor_4).launch(grid=[132, 1, 1], block=384)
    ...
    if warpidx_ >= 0 and warpidx_ < 8:
      ...
      for sched_idx in cutlass.range(cute.arch.block_idx()[0], 1024, 132):
        ...
        for k in cutlass.range(0, 32, 1):
          ...
          acc_69 = mma.single_gemm_ss(tidx_, 128, 128, tiled_mma_69, sQ, sK, state_c_q, state_c_k, 0)
        ...
        store.mma_epilogue_tma(tiled_mma_140, mO_tma_tensor_1_slice, mO_tma_atom_1, sO, acc_scaled, 128, 128, sched_coord[1], 0, tidx_, warpidx_, cutlass.Float32)
