...
"""
Triton Persistent matmul, copied directly from tutorial.
"""
...
# NOTE the pre_hook will change the descriptors' block shapes prior to kernel launch
@triton.autotune(
...
def matmul_kernel_tma(a_desc, b_desc, c_desc,  #
    ...
    """
    NOTE this is a version of matmul which uses TMA. warp_specialize can also be passed in to warp specialize
    """
...
def _compute_pid(tile_id, num_pid_in_group, num_pid_m, GROUP_SIZE_M, NUM_SMS):
    # NOTE this is the persistent (m, n) assignment
...
def matmul_kernel_descriptor_persistent(
    ...
    """
    NOTE this uses device-side descriptor creation, and is otherwise similar to persistent
    """
