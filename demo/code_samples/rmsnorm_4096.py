...
# Topologically Sorted Source Nodes: [rms_norm], Original ATen: [aten._to_copy, aten.pow, aten.mean, aten.add, aten.rsqrt, aten.mul]
# Source node to ATen node mapping:
#   rms_norm => add, convert_element_type, convert_element_type_1, mean, mul, pow_1, rsqrt
# Graph fragment:
