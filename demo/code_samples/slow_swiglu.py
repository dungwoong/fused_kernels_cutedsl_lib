"""
TorchInductor dump for fusing swiglu.

It does not do anything to the matmuls, it just fuses the silu and mul operation at the end
"""
...
#   mul => mul_1
#   silu => convert_element_type_4, convert_element_type_5, mul, sigmoid
# Graph fragment:
#   %convert_element_type_4 : [num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm, torch.float32), kwargs = {})
...
#   %convert_element_type_5 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul, torch.bfloat16), kwargs = {})
#   %mul_1 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_5, %mm_1), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [o1], Original ATen: [aten.mm]
        extern_kernels.mm(arg1_1, reinterpret_tensor(arg0_1, (4096, 4096), (1, 4096), 0), out=buf0)
        del arg0_1
        buf1 = empty_strided_cuda((4096, 4096), (4096, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [o2], Original ATen: [aten.mm]
        extern_kernels.mm(arg1_1, reinterpret_tensor(arg2_1, (4096, 4096), (1, 4096), 0), out=buf1)
        del arg1_1
        del arg2_1
        buf2 = buf0; del buf0  # reuse
        # Topologically Sorted Source Nodes: [silu, mul], Original ATen: [aten.silu, aten.mul]
        stream0 = get_raw_stream(0)
        triton_poi_fused_mul_silu_0.run(buf2, buf1, 16777216, stream=stream0)
        del buf1
    return (buf2, )
